...
public class NewButton extends DefaultXulOverlay {
  private final static String OVERLAY = "<overlay id=\"%s\" resourceBundle=\"%s\">%s</overlay>";
  private final static String MENU = "<button id=\"new.layout.btn\" label=\"%s\" command=\"%s\" />";
  private final static String COMMAND = "Home.openFile('%s','%s','%s');$('#btnCreateNew').popover('hide')";

  private String label;
  private String commandUri;

  public NewButton(String id, String resourceBundle ) {
    super( id, id, null, resourceBundle );
  }

  @Override
  public String getSource() {
    return String.format( OVERLAY, getId(), getResourceBundleUri(), getButtonXml() );
  }
